...
def build_gnn_data_for_schedule(
    ...
    # Store raw speedup values - log transform will be handled in training
...
class GNNDatasetParallel:
    ...
    def __getitem__(self, idx):
        # Return both data and attributes for compatibility
        return self.data_list[idx], self.attr_list[idx]
    
    def get_item_with_attrs(self, idx):
        """Get both data and attributes for analysis purposes"""
        return self.data_list[idx], self.attr_list[idx]
    
    def get_all_attrs(self):
        """Get all attributes for post-training analysis"""
        return self.attr_list
    
    def get_attrs_subset(self, indices):
        """Get attributes for specific indices"""
        return [self.attr_list[i] for i in indices]
